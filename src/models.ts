...
export class ResourceModel extends BaseModel {
  ...
  @Exclude()
  public static readonly TYPE_NAME: string = "Your::Resource::Here";
  ...
  @Expose({ name: "TPSCode" })
  @Transform(
    (value: any, obj: any) => transformValue(String, "tPSCode", value, obj, []),
    {
      toClassOnly: true,
    }
  )
  ...
  @Expose({ name: "Title" })
  @Transform(
    (value: any, obj: any) => transformValue(String, "title", value, obj, []),
    {
      toClassOnly: true,
    }
  )
  ...
  @Expose({ name: "DueDate" })
  @Transform(
    (value: any, obj: any) => transformValue(String, "dueDate", value, obj, []),
    {
      toClassOnly: true,
    }
  )
  ...
  @Expose({ name: "Tags" })
  @Transform(
    (value: any, obj: any) => transformValue(Tag, "tags", value, obj, [Set]),
    {
      toClassOnly: true,
    }
  )
...
export class Memo extends BaseModel {
  ...
  @Expose({ name: "Heading" })
  @Transform(
    (value: any, obj: any) => transformValue(String, "heading", value, obj, []),
    {
      toClassOnly: true,
    }
  )
  ...
  @Expose({ name: "Body" })
  @Transform(
    (value: any, obj: any) => transformValue(String, "body", value, obj, []),
    {
      toClassOnly: true,
    }
  )
...
export class Tag extends BaseModel {
  ...
  @Expose({ name: "Key" })
  @Transform(
    (value: any, obj: any) => transformValue(String, "key", value, obj, []),
    {
      toClassOnly: true,
    }
  )
  ...
  @Expose({ name: "Value" })
  @Transform(
    (value: any, obj: any) => transformValue(String, "value_", value, obj, []),
    {
      toClassOnly: true,
    }
  )
